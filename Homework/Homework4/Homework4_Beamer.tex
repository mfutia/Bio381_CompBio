...
% TITLE PAGE DATA--------------------------
\title[Field Pictures]{Pictures from the Field} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Matt Futia} % Your name
...
\medskip
\textit{mfutia@uvm.edu} % Your email address
}
...
\usepackage{Sweave}
\begin{document}
\input{Homework4_Beamer-concordance}
...
% SLIDE (BULLET POINTS)--------------------
\begin{frame}
\frametitle{Picture Overview}
\begin{itemize}
\item Fish surgery
\item Winter sampling
\item Lake trout spawning aggregation
\end{itemize}
\end{frame}

% SLIDE (FIGURE)-----------------------------
\begin{frame}
\frametitle{Fish Surgery}
% Uncomment the code on this slide to include your own image from the same directory as the template  file.
 \begin{figure}
   \includegraphics[width=6cm]{FishSurgery.jpg}
 \end{figure}
\begin{itemize}
  \item Lake trout receive an acoustic transmitter for tracking
  \item Transmitters surgically implanted into the body cavity
  \item Fish with transmitters are tracked for 1-3 years in Lake Champlain
\end{itemize}
\end{frame}

% SLIDE (FIGURE)-----------------------------
\begin{frame}
\frametitle{Winter Sampling}
% Uncomment the code on this slide to include your own image from the same directory as the template  file.
 \begin{figure}
   \includegraphics[width=4.5cm]{WinterSampling.jpg}
 \end{figure}
\begin{itemize}
  \item Lake trout are collected throughout the year, including winter
\end{itemize}
\end{frame}

% SLIDE (FIGURE)-----------------------------
\begin{frame}
\frametitle{Lake Trout Spawning}
% Uncomment the code on this slide to include your own image from the same directory as the template  file.
 \begin{figure}
   \includegraphics[width=7cm]{Spawning.jpg}
 \end{figure}
\begin{itemize}
  \item Lake trout congregate in the fall to spawn
\end{itemize}
\end{frame}
\end{frame}
